...
from mango_pipeline import PipelineLocal, juicepress
...
def cli_args():
    ...
    return juicepress.add_arguments(parser)
...
def main():
    ...
    # extract juicepress args from namespace, strip "jp" prefix from arg name
    juicepress_args = {k.replace("jp_", ""): v for k, v in vars(args).items() if k.startswith('jp_')}
    ...
    pipeline = pipeline_class(
        ...
        juicepress_args=juicepress_args,
    )
