**NOTE: This is a modified version of Operation Mango we used to evaluate JuicePress. We added various switches and classes that help us to profile execution times. All credit for this amazing prototype goes to Wil Gibbs and all other authors of the original paper. Unfortunately, we could not fork it, as github forks cannot be private.**

**Find the original repo [here](https://github.com/sefcom/operation-mango-public). They deserve a star and a good paper read.**
